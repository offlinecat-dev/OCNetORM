...
```typescript
import { defineEntity, ColumnType, EntityData, MetadataStorage, EntityHooks } from '@offlinecat/ocorm'
...
```typescript
import { EntityData, HookCallback, EntityHooks } from '@offlinecat/ocorm'
...
```typescript
import { HooksProcessor } from '@offlinecat/ocorm'
