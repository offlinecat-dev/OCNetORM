...
OCORM 是专为 HarmonyOS NEXT / OpenHarmony 5.0+ ArkTS 设计的轻量级 ORM 框架，提供 TypeORM 风格的 API，支持 SQLite 数据库操作。
...
```typescript
import { OCORMInit, DatabaseConfig, defineEntity, Repository, ColumnType, EntityData } from '@offlinecat/ocorm'
