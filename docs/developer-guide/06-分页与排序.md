...
if (params !== null) {
  ...
  console.log(params.pageSize)    // 10
  console.log(params.getOffset()) // 10
  console.log(params.getLimit())  // 10
}
```
...
```typescript
import { Repository, QueryBuilder, QueryExecutor, ConditionOperator } from '@offlinecat/ocorm'
