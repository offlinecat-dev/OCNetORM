...
- [`../02-使用手册/04-仓储与事务/00-Repository总览.md`](../02-使用手册/04-仓储与事务/00-Repository总览.md)
- [`../02-使用手册/04-仓储与事务/04-事务执行器-TransactionManager.md`](../02-使用手册/04-仓储与事务/04-事务执行器-TransactionManager.md)
- [`../02-使用手册/04-仓储与事务/07-原生SQL安全守卫-RawSqlGuards.md`](../02-使用手册/04-仓储与事务/07-原生SQL安全守卫-RawSqlGuards.md)
...
- [`../02-使用手册/09-安全与最佳实践/02-事务安全与并发保护.md`](../02-使用手册/09-安全与最佳实践/02-事务安全与并发保护.md)
- [`../02-使用手册/04-仓储与事务/05-事务守卫-嵌套-跨仓库-未绑定写入.md`](../02-使用手册/04-仓储与事务/05-事务守卫-嵌套-跨仓库-未绑定写入.md)
...
- [`../20-源码开发指南/13-测试与验收/04-回归清单-事务-查询-安全.md`](../20-源码开发指南/13-测试与验收/04-回归清单-事务-查询-安全.md)
...
- 深度章节：[`../02-使用手册/04-仓储与事务/00-Repository总览.md`](../02-使用手册/04-仓储与事务/00-Repository总览.md)、[`../02-使用手册/04-仓储与事务/09-仓储层性能与风险点.md`](../02-使用手册/04-仓储与事务/09-仓储层性能与风险点.md)
