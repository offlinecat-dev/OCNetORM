...
> 适用版本：ocorm 3.0.2
> 最后更新：2026-03-28
> 对照源码：`src/main/ets/query/QueryBuilder.ets`、`QueryExecutor.ets`、`RelationLoader.ets`、`QueryCache.ets`
...
- [`../05-查询体系/00-查询体系总览.md`](../05-查询体系/00-查询体系总览.md)
- [`../05-查询体系/07-RelationLoader与关系加载策略.md`](../05-查询体系/07-RelationLoader与关系加载策略.md)
- [`../13-性能与调优/03-缓存参数调优.md`](../13-性能与调优/03-缓存参数调优.md)
...
- [`../05-查询体系/03-子查询-whereExists-SubQuery.md`](../05-查询体系/03-子查询-whereExists-SubQuery.md)
- [`../05-查询体系/08-with-withLazy-withWhere-withCount.md`](../05-查询体系/08-with-withLazy-withWhere-withCount.md)
...
- [`../05-查询体系/11-查询安全守卫-QueryBuilderGuards.md`](../05-查询体系/11-查询安全守卫-QueryBuilderGuards.md)

## 9. 继续下钻

- 仓储事务：[`03-仓储-事务与原生SQLAPI.md`](./03-仓储-事务与原生SQLAPI.md)
- 深度章节：[`../05-查询体系/00-查询体系总览.md`](../05-查询体系/00-查询体系总览.md)、[`../05-查询体系/12-常见误用与失败语义.md`](../05-查询体系/12-常见误用与失败语义.md)
