...
> 适用版本：ocorm 3.0.2
> 最后更新：2026-03-28
> 对照源码：`OCORM/Index.ets`、`src/main/ets/core/index.ets`、`src/main/ets/decorators/index.ets`、`src/main/ets/types/index.ets`、`src/main/ets/errors/index.ets`
...
- [`../03-核心建模/01-实体模型与元数据.md`](../03-核心建模/01-实体模型与元数据.md)
- [`../03-核心建模/02-defineEntity与EntitySchema.md`](../03-核心建模/02-defineEntity与EntitySchema.md)
- [`../11-错误与日志/01-错误体系分层.md`](../11-错误与日志/01-错误体系分层.md)
...
- [`../02-架构总览/03-运行时生命周期.md`](../02-架构总览/03-运行时生命周期.md)
- [`../04-数据库与连接层/02-DatabaseManager生命周期.md`](../04-数据库与连接层/02-DatabaseManager生命周期.md)
...
- [`../03-核心建模/02-defineEntity与EntitySchema.md`](../03-核心建模/02-defineEntity与EntitySchema.md)
- [`../09-Schema与迁移/07-Unique索引映射规则.md`](../09-Schema与迁移/07-Unique索引映射规则.md)
...
- [`../03-核心建模/03-装饰器建模方式.md`](../03-核心建模/03-装饰器建模方式.md)
- [`../08-验证与钩子/02-ValidationDecorators规则集.md`](../08-验证与钩子/02-ValidationDecorators规则集.md)
...
- 建模：[`../03-核心建模/01-实体模型与元数据.md`](../03-核心建模/01-实体模型与元数据.md)、[`../03-核心建模/03-装饰器建模方式.md`](../03-核心建模/03-装饰器建模方式.md)
- 错误与日志：[`../11-错误与日志/01-错误体系分层.md`](../11-错误与日志/01-错误体系分层.md)、[`../11-错误与日志/05-日志级别与慢查询事件.md`](../11-错误与日志/05-日志级别与慢查询事件.md)
