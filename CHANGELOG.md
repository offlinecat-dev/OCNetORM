...
### 文档对齐（3.0）
- 《功能增强路线图》（`docs/99-功能增强路线图.md`）中的高优先级能力已在 3.0 主版本收敛（含聚合/分组、scope/scopes、withCount/withWhere、MorphTo 9.4、工具链能力）
- 《安全审查报告（2026-02-10）》（`docs/17-安全审查报告-2026-02-10.md`）列出的风险项已完成修复闭环并纳入 3.0 发布说明
